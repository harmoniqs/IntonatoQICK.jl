...
# sample_rate). The calibration chassis never calls these directly; the QickExperiment
...
Note: under line search the calibration chassis evaluates the experiment several times
